...
def crawling_img(name):
    ...
    for i in range(count):
        ...
        try:
            ...
            time.sleep(1)
            imgUrl = driver.find_elements(By.CSS_SELECTOR,"._image")[i].get_attribute("src")
            print(imgUrl)
...
driver.get('https://search.naver.com/search.naver?where=image&section=image&query=')#네이버
for idol in idols:
    crawling_img(idol)
